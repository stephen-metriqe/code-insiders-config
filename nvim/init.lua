...
if vim.g.vscode then
    ...
    {'n', 'w', 'cursorWordPartRight'}, {'n', 'b', 'cursorWordPartLeft'}, {'v', 'w', 'cursorWordPartRightSelect'},
    {'v', 'b', 'cursorWordPartLeftSelect'}, -- Code Navigation
    {'n', '<leader>gy', 'editor.action.goToTypeDefinition'}, {'n', '<leader>gi', 'editor.action.goToImplementation'},
    {'n', '<leader>gr', 'editor.action.goToReferences'}, {'n', '<leader>gs', 'workbench.action.gotoSymbol'},
    ...
    {'n', '<leader>vd', 'editor.action.peekDefinition'}, {'n', '<leader>vi', 'editor.action.peekImplementation'},
    ...
    {'n', '<leader>cp', 'copyFilePath'}, {'n', '<leader>cr', 'copyRelativeFilePath'},
    ...
    {'n', '<leader>rw', 'workbench.action.reloadWindow'}, {'n', '<leader>os', 'workbench.action.openSettingsJson'},

    -- Jupyter Notebook handling
    {'n', '<leader>ec', 'notebook.cell.execute'}, {'n', '<leader>cb', 'notebook.cell.insertCodeCellBelow'},
    {'n', '<leader>ca', 'notebook.cell.insertCodeCellAbove'}, {'n', '<leader>co', 'notebook.cell.clearOutputs'},
    {'n', 'zO', 'editor.unfoldRecursively'}, {'n', 'za', 'editor.toggleFold'}, {'n', 'zR', 'editor.unfoldAll'},
    {'n', 'zM', 'editor.foldAll'}}
